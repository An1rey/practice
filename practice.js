...
// function kvadrat(pattern_sting, first) {
//     return first*first;
// }
...
//     console.log("Среднее арифметическое " + (sum/500))
...
//     result = isFirst ? current * next : result * current
// }
// console.log(result)
//9.Вивести суму тільки парних чисел в діапазоні від 30 до 80
// const isEvenNumbers = (num) => num % 2 === 0
// const isFirstIteration = (firstNum, currentNum) => firstNum === currentNum
...
//             result = isFirstIteration(start, current)? current + next: current + next + result
//         }
//     }
//     return result
// }
